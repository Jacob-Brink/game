...
class Player(RigidBody):
    ...
    def __init__(self, keyboard_layout, debug_mode):
        ...
        super().__init__(Rectangle((0,0),(200, 200)), 100)
    ...
    def return_surface_and_pos(self):
        ...
        if self._debug:
            return [Text('Player'+str(self._player_num) + 'Pos: ' + str(self.return_rect()), 64, (200,255,255), 'left', 10).get_surface(), super().return_rect().get_center()]
        else:
